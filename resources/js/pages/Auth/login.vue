<template>
    <div
        class="bg-[url('/admin_resource/bg-body.png')] bg-no-repeat bg-contain min-h-screen bg-gray-200 flex justify-center items-center"
    >
        <div
        ...
        >
            <div class="text-center px-6 bg-slate-900 rounded-t py-8">
                <a href="#"
                    ><img
                        src="/admin_resource/shopping-bag.svg"
                        alt=""
                        class="w-14 h-14 mx-auto mb-2"
                /></a>
                <h3 class="font-semibold text-white text-xl mb-1">
                    Let's Get Started E-BD
                </h3>
                <p class="text-xs text-slate-400">
                    Sign in to continue to E-BD.
                </p>
            </div>
            ...
            <form @submit.prevent="login()" class="p-6 mb-4">
                <div>
                    ...
                    <input
                        ...
                        v-model="username"
                        id="email"
                        class="block mt-1 p-2 text-sm w-full rounded border outline-none border-slate-300 focus:border-orange-400 invalid:border-red-600"
                ...
                <div class="mt-6">
                    ...
                    >
                        ...
                        <span v-if="loading">
                            <i
                                class="animate-spin fa-solid fa-circle-notch"
                            ></i>
                        </span>
                    </button>
                </div>
...
export default {
    ...
    methods: {
        async login() {
            try {
                this.loading = true;
                const formData = commonFunction.formdata({
